        ...
        <div class="container">
            <div class="row">
                ...
                <div class="vitalscrollmenu">
                    ...
                    <a class="active" href="diabetic_history_weight.php">Weight(in Kg)</a>
                ...
                <table class="table table-striped">
                        ...
                        $s = 1; 
$x = $_SESSION['email'];
// echo "SELECT * FROM `add_vital_weight` where `user_id`='$x'";
$get = mysqli_query($conn , "SELECT * FROM `add_vital_weight` where `user_id`='$x'");
