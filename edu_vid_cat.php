...
<body>
   ...
   <div class="pt-5">
        <div class="container-fluid theme-container">
                <div class="row mb-2">
                    <div class="col">
                        <h5 class="product-heading">Select Session</h5>
                    </div>
                </div>
            <div class="row">
            <?php
                ...
                <div class="col-lg-3 col-xs-12 col-12 mt-3">
                    <a href="edu_videos.php?id=<?php echo $all_rows['sno']; ?>" class="btn btn-primary btn-lg btn-block text-dark"><?php echo $all_rows['cat_name']; ?></a>
                </div>
                <?php } ?>
            </div>
        </div>
