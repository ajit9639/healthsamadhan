...
if(isset($_POST['submit']))
  {
    ...
    $edu_vid_product1 =         $_POST['edu_vid_product1'];
    ...
    // end getting categories image files
        ...
        {
         $query = " INSERT INTO edu_vid_product ( vid_cat,vid_name, edu_vid,edu_vid_product1 ) VALUES ('$vid_cat', '$vid_name', '$filename','$edu_vid_product1')";
                            ...
                            <form class="forms-sample" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select type="text" name="vid_cat" id="country" class="form-control">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <label for="vid_name"> <label for="edu_vid">Add Youtube URL of Upload Educational Video </label>                                        
                                        <input type="text" class="form-control" id="edu_vid_product1" name="edu_vid_product1">
                                    </div>
