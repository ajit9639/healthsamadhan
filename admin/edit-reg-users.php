                  ...
                  <div class="table-responsive pt-3">
                    <table class="table table-bordered">
                     <thead>
                      ...
                      <?php
                      while($all_rows = mysqli_fetch_assoc($fetched_data))
                        {
                        ...
                        echo "<tr>
                                ...
                                <td>
                                    ...
                                    <a class='btn btn-success text-white' href='edit-vendors-record-entry.php?id=$all_rows[sno]'><i class='typcn typcn-edit btn-icon-append'></i></a>
                                    
                                  <span>
                                  
                                    <a class='btn btn-danger text-white' href='delete-vendor-record-entry.php?id=$all_rows[sno]'><i class='typcn typcn-delete-outline btn-icon-append'></i></a>
