            ...
            <div class="row">
                ...
                <form method="POST" id="form" action="package_pay/index.php">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <label>Your Selected Package </label><br>

                            <select type="text" name="productinfo" id="package" required="true"
                             onClick="getsate(this.value)" class="form-control">
                                
                                <?php $query=mysqli_query($conn,"select * from `package` where `id`='$get_pack_id'");
