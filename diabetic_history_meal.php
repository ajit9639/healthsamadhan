        ...
        <div class="container">
            <div class="row">
               ...
               <div class="vitalscrollmenu">
                    <a class="active" href="diabetic_history_meal.php">Meal Pattern</a>
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        $s = 1; 
$x = $_SESSION['email'];
// echo "SELECT * FROM `add_vital_meal_pattern` where `user_id`='$x'";
$get = mysqli_query($conn , "SELECT * FROM `add_vital_meal_pattern` where `user_id`='$x'");
