    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu bg-dark">
                <a class="dropdown-item" href="medicines.php">Buy Medicine</a>
                <a class="dropdown-item" href="medicine_history.php">Orders</a>
            </div>
        </li>
      ...
      <a class="nav-link" href="medicines.php">Buy Medicine</a>
        ...
        <!-- <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
                <i class="fa fa-bell"></i> <span class="badge badge-secondary badge-success"><?= $unread_count ?></span>
            </a>
            <div class="dropdown-menu bg-dark"> -->
			...
			// 			while($row_message=mysqli_fetch_assoc($res_message)){?>
                      <!-- <p class="text-light p-2 mb-0"><strong><?php echo $row_message['name']?></strong> message From  <?php echo $row_message['fname']?></p> -->
					 <?php //} } 
                     ?>
                ...
                <ul>
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu w-100">
                            <a href="medicines.php">Buy Medicine</a>
                            <a href="medicine_history.php">Orders</a>
                        </div>
                    </li>
                    ...
                    <!-- <li><a href="#"><i class="fa fa-bell"></i> <span
                                class="badge badge-secondary badge-success">2</span></a></li> -->
