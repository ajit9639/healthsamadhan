...
<?php include 'header.php' ?>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer"
                            style="background-image: url(assets/images/backgrounds/bgn-slider-01.jpg);"></div>
                        <!-- /.image-layer -->
                        ...
                        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                            <div class="feature-one__single">
                                <div class="feature-one__single-inner">
                                    ...
                                    <p class="feature-one__text">Health Samadhan provides quick and easy access to health information. It is a one-stop shop for all your health needs. You can find information on diseases, symptoms, treatments, and medications. We have a team of experienced doctors who provide quality care to their patients.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                            <div class="feature-one__single">
                                <div class="feature-one__single-inner">
                                    ...
                                    <p class="feature-one__text">Our platform enables you to consult with a doctor from the comfort of your home. You can either choose to have a video consultation or a chat consultation. During the consultation, you can ask the doctor any questions that you may have about your health.
                        ...
                        <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                            <div class="feature-one__single">
                                <div class="feature-one__single-inner">
                                    ...
                                    <p class="feature-one__text">Health Samadhan provides quick support for those seeking better health. We operate 24/7 and provide access to a team of health experts who can offer guidance and support on various health issues. We also provide a range of online tools and resources, making it easy for users to find the information they need.</p>
                                </div>
                            </div>
                        </div>
                        <!--Feature One Single End-->
        ...
        <section class="about-one">
            ...
            data-wow-duration="2500ms" style="background-image: url(assets/images/backgrounds/about-one-bg.png);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                        <div class="about-one__left">
                            ...
                            data-wow-duration="2500ms">
                                <div class="about-one__img">
                                    <img src="assets/images/resources/3.jpg" class="img-fluid" style="width:80%;" alt="">
                                </div>
                                <div class="about-one__experience">
                                    <h2 class="about-one__experience-year">5+</h2>
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__right">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title"> We are covering all the Health field.</h2>
                            </div>
                            
                            <p class="about-one__text-2">Health Samadhan is a website & app  that covers all aspects of health. This includes mental health, physical health, and emotional health. In addition, we provide information on how to maintain a healthy lifestyle, how to prevent diseases, and how to treat illnesses. 
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="services-one__top-left">
                                <div class="section-title text-left">
                                    ...
                                    <h2 class="section-title__title">We’re covering all the Health fields</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-7 col-lg-6">
                            <div class="services-one__top-right">
                                <p class="services-one__top-text">Since its inception, Health samadhan has been on a mission to provide the best online medical healthcare experience possible. To do this, we have constantly strived to improve our platform and offerings. Here are some of the ways we have become the best in class.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="why-choose-one">
            <div class="why-choose-one-shape-1" style="background-image: url(assets/images/shapes/why-choose-one-shape-1.png);"></div>
                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="why-choose-one__left">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title1">Few reasons for people choosing Health Samadhan</h2>
                            </div>
                                ...
                                <ul class="list-unstyled why-choose-one__list">
                                        ...
                                        <div class="why-choose-one__single">
                                            ...
                                            <div class="why-choose-one__list-title-box">
                                                ...
                                                <div class="why-choose-one__list-text-box">
                                                    <p class="why-choose-one__list-text">Health Samadhan is an excellent choice for people who want fast and easy access to healthcare. The process is straightforward, and you can start in just a few minutes.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="why-choose-one__single">
                                            ...
                                            <div class="why-choose-one__list-title-box">
                                                <div class="why-choose-one__list-title-inner">
                                                    <h3 class="why-choose-one__list-title"> More control over Policy.</h3>
                                                </div>
                                                <div class="why-choose-one__list-text-box">
                                                    <p class="why-choose-one__list-text">People who choose Health Samadhan have control over their insurance policy. They can decide how much coverage they need and what type is best for them. They're not beholden to an employer-sponsored plan or government program.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="why-choose-one__single">
                                            ...
                                            <div class="why-choose-one__list-title-box">
                                                <div class="why-choose-one__list-title-inner">
                                                    <h3 class="why-choose-one__list-title">Save Money</h3>
                                                </div>
                                                <div class="why-choose-one__list-text-box">
                                                    <p class="why-choose-one__list-text">Health Samadhan is a great way to save money on your healthcare. We offer a variety of plans that can save you money on your monthly premiums. We also have a network of doctors and hospitals that you can use, saving you even more money.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
        ...
        <section class="get-insurance">
            <div class="get-insurance-bg" style="background-image: url(assets/images/backgrounds/get-insurance-bg.png);"></div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-6">
                    ...
                    <div class="col-xl-6">
                        <div class="get-insurance__right">
                            <div class="section-title text-left">
                                ...
                                <h2 class="section-title__title">Get free consultation <br>  get started!</h2>
                            </div>
                                                    ...
                                                    <div class="get-insurance__content-box">
                                                        ...
                                                        <div class="get-insurance__input-box">
                                                            <select class="selectpicker" aria-label="Default select example">
                                                                ...
                                                                <option value="1">Diabetic Consultation</option>
                                                                <option value="2">Full Health Consultation</option>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        <div class="counter-one__single">
                            ...
                            <p class="counter-one__text">Professional Experts</p>
                        </div>
                    </div>
                    <!--Counter One Single End-->
                    <!--Counter One Single Start-->
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="team-one__bottom">
                            <p class="team-one__bottom-text">Contact Our Expert Team Member To Take Our <span>Best Policies</span></p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6">
                            <div class="testimonial-one__top-right">
                                <p class="testimonial-one__top-text">
"I was sceptical about the fact that I would not see a doctor but in no time at all, we got connected to one of the doctors and they answered my questions. After speaking with them for a few minutes, I felt reassured. The next day, I got an email from the doctor again asking me if I had any further questions."</p>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="testimonial-one__client-info">
                                                ...
                                                <div class="testimonial-one__client-content">
                                                    ...
                                                    <div class="testimonial-one__client-details">
                                                        <h3 class="testimonial-one__client-name">Raj kumar</h3>
                                                        <p class="testimonial-one__client-sub-title"></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <p class="testimonial-one__text">"Health Samadhan is one of the most reliable sites I've found for Healthcare facilities. The site has a lot of medical professionals, and it's easy to find the best healthcare provider for your needs. I was having a hard time finding someone to offer my daughter the care she needed and with this site, we were able to find someone right away."</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                ...
                                <div class="item">
                                    <div class="testimonial-one__single">
                                        <div class="testimonial-one__single-inner">
                                            ...
                                            <p class="testimonial-one__text">"I would recommend Health Samadhan to anyone looking for a good and affordable healthcare facility. I was able to get all my medical treatments done in one place, and the online system made it so easy to apply for health care services."</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
