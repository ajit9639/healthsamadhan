            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="site-footer__bottom-inner">
                        <div class="row">
                            <div class="col-lg-6">
                                <p class="site-footer__bottom-text" style="float: left;">© All Copyright 2022 by <a href="#">HealthSamadhan.com</a></p>
                            </div>
                            <div class="col-lg-6">
                                <p class="site-footer__bottom-text" style="float: right;">Powered by <a  href="https://insightinfosystem.com">Insight Infosystem</a></p>
                            </div>
                        </div>
                    </div>
                </div>
